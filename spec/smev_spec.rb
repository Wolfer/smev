...
describe Smev::Message do   
  ...
  describe "created" do
    ...
    it 'from hash' do
      hash = {"name"=>"SendRequestRq", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"Message", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"Sender", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"Code", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{}}}, {"name"=>"Name", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{}}}]}]}, {"name"=>"Recipient", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"Code", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{}}}, {"name"=>"Name", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{}}}]}]}, {"name"=>"Originator", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"Code", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{}}}, {"name"=>"Name", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{}}}]}]}, {"name"=>"TypeCode", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{}}}, {"name"=>"Date", "type"=>"element", "value"=>{"type"=>"dateTime", "restriction"=>{}}}, {"name"=>"RequestIdRef", "type"=>"element", "min_occurs"=>0, "value"=>{"type"=>"string", "restriction"=>{}}}, {"name"=>"OriginRequestIdRef", "type"=>"element", "min_occurs"=>0, "value"=>{"type"=>"string", "restriction"=>{}}}, {"name"=>"ServiceCode", "type"=>"element", "min_occurs"=>0, "value"=>{"type"=>"string", "restriction"=>{}}}, {"name"=>"CaseNumber", "type"=>"element", "min_occurs"=>0, "value"=>{"type"=>"string", "restriction"=>{}}}]}]}, {"name"=>"MessageData", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"AppData", "type"=>"element", "min_occurs"=>0, "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"Документ", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"СвЮЛ", "type"=>"element", "attributes"=>[{"type"=>"string", "restriction"=>{"minlength"=>1, "maxlength"=>1000}, "name"=>"НаимЮЛ", "use"=>"required"}, {"type"=>"string", "restriction"=>{"length"=>10, "pattern"=>"([0-9]{1}[1-9]{1}|[1-9]{1}[0-9]{1})[0-9]{8}"}, "name"=>"ИННЮЛ", "use"=>"required"}, {"type"=>"string", "restriction"=>{"length"=>13, "pattern"=>"[0-9]{13}"}, "name"=>"ОГРН", "use"=>"required"}]}, {"name"=>"ЗапросНП", "type"=>"element", "children"=>[{"name"=>"Choice", "type"=>"choice", "children"=>[{"name"=>"ИННЮЛ", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{"length"=>10, "pattern"=>"([0-9]{1}[1-9]{1}|[1-9]{1}[0-9]{1})[0-9]{8}"}}}, {"name"=>"ИННФЛ", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{"length"=>12, "pattern"=>"([0-9]{1}[1-9]{1}|[1-9]{1}[0-9]{1})[0-9]{10}"}}}]}], "attributes"=>[{"type"=>"string", "restriction"=>{"length"=>10, "pattern"=>"(((0[1-9]{1}|[1-2]{1}[0-9]{1})\.(0[1-9]{1}|1[0-2]{1}))|((30)\.(0[1,3-9]{1}|1[0-2]{1}))|((31)\.(0[1,3,5,7,8]{1}|1[0,2]{1})))\.(19[0-9]{2}|20[0-9]{2})"}, "name"=>"ДатаНа", "use"=>"required"}]}]}], "attributes"=>[{"type"=>"string", "restriction"=>{"enumeration"=>["4.02"], "minlength"=>1, "maxlength"=>5}, "name"=>"ВерсФорм", "use"=>"required"}, {"type"=>"string", "restriction"=>{"length"=>36}, "name"=>"ИдЗапросП", "use"=>"optional"}]}]}]}, {"name"=>"AppDocument", "type"=>"element", "min_occurs"=>0, "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"BinaryData", "type"=>"element", "value"=>{"type"=>"base64Binary", "restriction"=>{}}}, {"name"=>"Reference", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"Include", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence"}], "attributes"=>[{"type"=>"anyURI", "restriction"=>{}, "name"=>"href", "use"=>"required"}]}]}]}, {"name"=>"DigestValue", "type"=>"element", "value"=>{"type"=>"base64Binary", "restriction"=>{}}}]}]}]}]}]}]}
      #{"name"=>"Документ", "type"=>"element", "children"=>[{"name"=>"Sequence", "type"=>"sequence", "children"=>[{"name"=>"СвЮЛ", "type"=>"element", "attributes"=>[{"type"=>"string", "restriction"=>{"minlength"=>1, "maxlength"=>1000}, "name"=>"НаимЮЛ", "use"=>"required"}, {"type"=>"string", "restriction"=>{"length"=>10, "pattern"=>"([0-9]{1}[1-9]{1}|[1-9]{1}[0-9]{1})[0-9]{8}"}, "name"=>"ИННЮЛ", "use"=>"required"}, {"type"=>"string", "restriction"=>{"length"=>13, "pattern"=>"[0-9]{13}"}, "name"=>"ОГРН", "use"=>"required"}]}, {"name"=>"ЗапросНП", "type"=>"element", "children"=>[{"name"=>"Choice", "type"=>"choice", "children"=>[{"name"=>"ИННЮЛ", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{"length"=>10, "pattern"=>"([0-9]{1}[1-9]{1}|[1-9]{1}[0-9]{1})[0-9]{8}"}}}, {"name"=>"ИННФЛ", "type"=>"element", "value"=>{"type"=>"string", "restriction"=>{"length"=>12, "pattern"=>"([0-9]{1}[1-9]{1}|[1-9]{1}[0-9]{1})[0-9]{10}"}}}]}], "attributes"=>[{"type"=>"string", "restriction"=>{"length"=>10, "pattern"=>"(((0[1-9]{1}|[1-2]{1}[0-9]{1})\.(0[1-9]{1}|1[0-2]{1}))|((30)\.(0[1,3-9]{1}|1[0-2]{1}))|((31)\.(0[1,3,5,7,8]{1}|1[0,2]{1})))\.(19[0-9]{2}|20[0-9]{2})"}, "name"=>"ДатаНа", "use"=>"required"}]}]}], "attributes"=>[{"type"=>"string", "restriction"=>{"enumeration"=>["4.02"], "minlength"=>1, "maxlength"=>5}, "name"=>"ВерсФорм", "use"=>"required"}, {"type"=>"string", "restriction"=>{"length"=>36}, "name"=>"ИдЗапросП", "use"=>"optional"}]}
